...
## Entrega estável de 24/09/2026 — versão pública e guia do professor
- Produção atualizada no domínio `https://pem-monarcas.vercel.app`. Merge publicado: `2681d52934ddcd8e45a9efec9466885333a28008`, deployment `dpl_5BrhyUHt6JgtFUFWe7GBRDQoubUs`. Rollback preservado: commit `5e1982b`, deployment `dpl_65QCMoeuWgmEfoKiu7XH16kpDPYe`.
...
- Evidência remota: CI `quality` verde; produção `dpl_5BrhyUHt6JgtFUFWe7GBRDQoubUs` READY; desktop e mobile conferidos; roteiro com 9 etapas; contador 45/52 em 24/09; sem overflow, 5xx ou erros de runtime. A suíte de produção encontrou e corrigiu um teste com origem local fixa; o portal ficou 4/4 verde após usar a origem do ambiente.
- P15: `docs/GUIA-PROFESSOR.txt` e PDF final foram atualizados para a versão pública. O guia usa `https://pem-monarcas.vercel.app`, orienta “Explorar demonstração” ou `visitante` / `monarcas`, descreve o que existe e separa claramente IA, OCR, questões extras e simulado ainda planejados. PDF entregue na pasta compartilhada do P.E.M substituindo o TXT antigo.
