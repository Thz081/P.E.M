...
- P16 em andamento: `scripts/build-curriculum.mjs` leu 22 imagens de organização, 183 títulos de PDFs e o gráfico de incidência do Assad. Mapa privado em `../analise/acervo/curriculum-map.json`: 165 grupos em ordem visível de estudo, 146 vínculos diretos, 37 pendências, 30 correspondências diretas com incidência atribuída ao Assad. Não há trimestre da turma neste mapa; pré-requisitos sugeridos e correspondências ambíguas aguardam revisão. Evidência em `docs/MAPA-CURRICULAR.md`. Kanban continua 14/26; próximo P17.
- Verificação P16: duas execuções do gerador produziram SHA-256 idêntico `00399471e73d717071f904527942090dee0eea4954326d072088d82c12720f317`; `node --check`, lint e `git diff --check` passaram. Os arquivos privados continuam fora do Git. P17 ainda pede OCR/revisão de 323 páginas; P16 e P17 não foram fechadas.
- P17: `scripts/build-ocr-queue.mjs` conferiu índice e arquivos extraídos e gerou fila privada e determinística de 323 páginas para revisão visual/OCR, sem textos originais no Git. Biologia concentra 183. Relatório `docs/TRIAGEM-P17.md`; OCR ainda não aplicado, P17 aberta.
...
- Kanban **14/26 concluídas, 12 abertas**. Próximo bloco P25/P26: preparar segurança, preview e rollback com Sol médio; Astra alto para decisão final prevista no quadro. Aviso de senhas vazadas desativado ainda pendente em P25. Produção antiga preservada e IA desligada. Não anunciar nova versão nem PDF atualizado.
