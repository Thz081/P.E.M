...
P17 parcial: `scripts/build-ocr-queue.mjs` gerou `../analise/acervo/extracted/ocr-queue.json` com 323 páginas sinalizadas, sem copiar texto. 183 são de Biologia. `docs/TRIAGEM-P17.md`. Revisão visual e OCR seletivo ainda pendentes; não fechar P17.
